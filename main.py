...
if __name__ == '__main__':
    ...
    if len(args) < 2:
        print("Usage:", "main.py [generate-sequences | similarity-matrix | svm-model] [options...]", sep="\n")
        exit()
    ...
    if args[1] == "generate-sequences":
        ...
        fw = FileWriter(args[6], "Alternate-Model", alternate_model_sequenze, alternate_model_nomi, (int(args[3]), int(args[2]), int(args[4]), float(args[5])))
        fw.SaveDataset()
